...
document.getElementById('searchBoxUser').addEventListener('input', (e) => {
    const searchStr = e.target.value.toLowerCase();
    const filteredUsers = users.filter(user => user.name.toLowerCase().includes(searchStr));
...
function renderUserList(userList) {
    ...
    userList.forEach(user => {
        ...
        userElem.addEventListener('click', () => renderUserPosts(user.id));
